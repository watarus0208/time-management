const app = new Vue({
    ...
    methods: { 
        updateTime: function() { 
            ...
            // 現在の年月日
            this.date = this.zeroPadding(current_date.getFullYear(), 4) + '年' + this.zeroPadding(current_date.getMonth() + 1, 2) + '月' + this.zeroPadding(current_date.getDate(), 2) + '日' + this.week[currentdate.getDay()]
        },
